...
public class AdminReviewSearchListCommand2 implements Command {
	...
	public void execute(Model model) {
		...
		if(searchOption == 1) {
			model.addAttribute("list", dao.searchReviewByContent2(search));
		} else if(searchOption == 2) {
			model.addAttribute("list", dao.searchReviewById2(search));
